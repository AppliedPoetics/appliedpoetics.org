...
// COMMAND HANDLING
	...
	if($cmd == 'tautogram' || $cmd == 'lipogram' || $cmd == 'isolate' || $cmd == 'beaupresente' || $cmd == 'univocalism' || $cmd == 'nthword' || $cmd == 'belleabsente' || $cmd == 'powerball' || $cmd == 'regexp' || $cmd == 'strlen' || $cmd == 'birthdate') 
	{ 

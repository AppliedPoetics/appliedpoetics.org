			...
			<div id = "option-container">
				...
				<div class = "dropdown" tabindex = "0" onclick = 'javascript: expandMenu("grammar");'>
					...
					<div class = "dropdown-content" id = "grammar-menu">
						...
						<a href = "#" id = "hexwords" data-toggle="popover" data-html="true" title = "Hexwords" data-content = "<form onsubmit = 'return runTool(this)' action = '#'><input type = 'hidden' name = 'cmd' value = 'hexwords' id = 'cmd'><input type ='Submit' value = 'Run'><div class = 'tool-explain'>This generator translates your text into spellings which only contain characters in the base 16 alphabet (0-9, a-f). Routine is adapted from other written by Ned Batchelder.</div></form>">Hexwords</a>
					</div>
				</div>
				...
				<div class = "dropdown"tabindex = "0" onclick = 'javascript: expandMenu("pop");'>
					...
					<div class = "dropdown-content" id = "pop-menu">
						<a href = "#" id = "powerball" data-toggle="popover" data-html="true" title = "Powerball" data-content = "<form onsubmit = 'return runTool(this)' action = '#'><label>The latest numbers are:</label><div id = 'powerball'></div><input type = 'hidden' name = 'cmd' value = 'powerball' id = 'cmd'><input type ='Submit' value = 'Run'><div class = 'tool-explain'>This routine uses the latest Powerball numbers to read a text, taking each non-Powerball number as the n<sup>th</sup> number in the text, cycling once it reaches the end of the sequence, with the Powerball as the title. The latest numbers are courtesy of the New York state lottery API.</div></form>" onclick = "javascript: powerball();">Powerball</a>
				...
				<div class = "dropdown" tabindex = "0" onclick = ''>
					<button class = "drop-btn" id = "share-menu" href = "#" data-toggle="popover" data-html="true" title = "Share a Utility" data-content = "<form onsubmit = 'return shareTool(this)' action = '#'><div class = 'styled-select'><select name = 'util' id = 'util'><option value = 'tautogram'>Tautogram</option><option value = 'lipogram'>Lipogram</option><option value = 'homoconsonant'>Homoconsonant</option><option value = 'fibonnaci'>Fibonnaci Sequence</option><option value = 'prisoners'>Prisoner's Constraint</option><option value = 'belleabsente'>Belle Absente</option><option value = 'beaupresente'>Beau Presente</option><option value = 'univocalism'>Univocalism</option><option value = 'snowball'>Snowball</option><option value = 'punctuator'>Punctuator</option><option value = 'isolate'>Isolate Sentences</option><option value = 'quotation'>Quotations</option><option value = 'partsofspeech'>Parts of Speech</option><option value = 'concordance'>Concordance</option><option value = 'regex'>Regular Expressions</option><option value = 'abecedarian'>Abecedarian</option><option value = 'abcquence'>ABC-Quence</option><option value = 'chainreaction'>Chain Reaction</option><option value = 'synonymizer'>Synonymizer</option><option value = 'alternator'>Alternator</option><option value = 'travesty'>Travesty</option><option value = 'proofofwork'>Proof of Work</option><option value = 'blockchain'>Blockchain</option><option value = 'nthword'>Nth Word</option><option value = 'pithon'>Pi-Thon</option><option value = 'atlength'>At Length</option><option value = 'birthdate'>Birthdate</option><option value = 'phonewords'>Phonewords</option><option value = 'dialatext'>Dial-a-Text</option><option value = 'powerball'>Powerball</option><option value = 'lost'>The Lost Numbers</option><option value = 'weather'>Weather Forecast</option><option value = 'coloring'>Coloring Book</option></select></div><input type ='Submit' value = 'Get Link'><div class = 'tool-explain'><input type = 'text' id = 'shareFld' onClick = 'this.select()' id = 'lttr' readonly/><br/></br/>Click the above field and copy the link (Windows: Control + C, Mac: Command + C) to share!</div></form>">Share a Utility</button>
				</div>
			</div>
		</div>
<div id = "page-wrapper">

			...
			<div id = "option-container">
				...
				<div class = "dropdown" tabindex = "0" onclick = 'javascript: expandMenu("grammar");'>
					...
					<div class = "dropdown-content" id = "grammar-menu">
						...
						<a href = "#" data-toggle="popover" data-html="true" title = "Anagram" data-content = "<form onsubmit = 'return runTool(this)' action = '#'><input type = 'hidden' name = 'cmd' value = 'permutations' id = 'cmd'><input type ='Submit' value = 'Run'><div class = 'tool-explain'>Attempts a best-fit anagram for the given text. As of yet, it's imperfect, but it's getting better.</div></form>">Anagram</a>
						...
						<a href = "#" id = "homophonic" data-toggle="popover" data-html="true" title = "Homophonic Translation" data-content = "<form onsubmit = 'return runTool(this)' action = '#'><div class = 'styled-select'><select name = 'lttr' id = 'lttr'><option value = 'translate'>Translate</option><option value = 'phonics'>Phonics Only</option></select></div><input type = 'hidden' name = 'cmd' value = 'homophonic' id = 'cmd'><input type ='Submit' value = 'Run'><div class = 'tool-explain'>Performs a homophonic, phoetic translation of a text. While the routine can sample entire pages, it's probably best to do it a poem/paragraph at a time.</div></form>">Homophonic Translation</a>
					</div>
				</div>
				<div class = "dropdown" tabindex = "0" onclick = 'javascript: expandMenu("algo");'>
					...
					<div class = "dropdown-content" id = "algo-menu">
						...
						<a href = "#" id = "editdistance" data-toggle="popover" data-html="true" title = "Edit Distance" data-content = "<form onsubmit = 'return runTool(this)' action = '#'><label>Enter a maximum edit distance:</label><input type = 'text' id = 'lttr' onkeypress='restrictNumberKeys(this)' placeholder = '3' maxlength=20><input type = 'hidden' name = 'cmd' value = 'levdistance' id = 'cmd'><input type ='Submit' value = 'Run'><br/><div class = 'tool-explain'>Returns all words in a text within a given Levenshtein distance or 'edit distance.' The default is 3 edits.</div></form>">Edit Distance</a>
					</div>
				</div>
...
<div id = "tos-popover">
	...
	<div id = "tos-text" onclick = "javsacript: tosPopover();">
		<center>Applied Poetics ver 1.<?php echo date("y.m.d:Hi", filemtime('index.php')); ?><br/>Concocted in Baltimore, Maryland<br/><br/></center>

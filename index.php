			...
			<div id = "option-container">
				...
				<div class = "dropdown" tabindex = "0" onclick = 'javascript: expandMenu("algo");'>
					...
					<div class = "dropdown-content" id = "algo-menu">
						...
						<a href = "#" id = "colorfield" data-toggle="popover" data-html="true" title = "Color Field" data-content = "<form onsubmit = 'return runTool(this)' action = '#'><input type = 'hidden' name = 'cmd' value = 'colorfield' id = 'cmd'><input id='filename' placeholder='Choose file.' disabled='disabled' /><div class = 'fileupload btn btn-primary'>Choose Image<input type = 'file' class = 'upload' id = 'uploadbtn' /></div><br/><br/><div class = 'styled-select'><select name = 'lttr' id = 'lttr'><option value = 'sentences'>Containing</option><option value = 'letters'>Spelled By</option></select></div><hr/><input type ='Submit' value = 'Run'><br/><div class = 'tool-explain'>'Color Field' scans through an uploaded image to find all of the distinct colors present.<br/><Br/> The 'Sentences' option pulls out sentences containing colors found in that image; the 'Spelled By' image finds all words spelled from the letters which make up these colors.</div></form>">Color Field</a>
					</div>
				</div>

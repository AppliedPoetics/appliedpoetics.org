			...
			<div id = "option-container">
				...
				<div class = "dropdown"tabindex = "0" onclick = 'javascript: expandMenu("pop");'>
					...
					<div class = "dropdown-content" id = "pop-menu">
						...
						<a href = "#" id = "coloring" data-toggle="popover" data-html="true" title = "Sartorializer" data-content = "<form onsubmit = 'return runTool(this)' action = '#'><input type = 'hidden' name = 'cmd' value = 'fashion' id = 'cmd'><input type ='Submit' value = 'Run'><div class = 'tool-explain'>Using a predefined (and periodically updated) list of fashion terms, the 'Sartorializer' function retrieves all sentences containing terms related to dress and clothing.</div></form>">Sartorializer</a>
					</div>
				</div>

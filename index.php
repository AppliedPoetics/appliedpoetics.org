			...
			<div id = "option-container">
				<div class = "dropdown" tabindex = "0" id = "oulipo" onclick = 'javascript: expandMenu("oulipo");'>
					...
					<div class = "dropdown-content" id = "oulipo-menu">
						<a href = "#" data-toggle="popover" data-html="true" title = "Tautogram" data-content = "<form onsubmit = 'return runTool(this)' action = '#'><div class = 'styled-select'><select name = 'lttr' id = 'lttr'><option value = 'a'>a</option><option value = 'b'>b</option><option value = 'c'>c</option><option value = 'd'>d</option><option value = 'e'>e</option><option value = 'f'>f</option><option value = 'g'>g</option><option value = 'h'>h</option><option value = 'i'>i</option><option value ='j'>j</option><option value = 'k'>k</option><option value = 'l'>l</option><option value = 'm'>m</option><option value = 'n'>n</option><option value = 'o'>o</option><option value = 'p'>p</option><option value = 'q'>q</option><option value = 'r'>r</option><option value = 's'>s</option><option value = 't'>t</option><option value = 'u'>u</option><option value= 'v'>v</option><option value = 'w'>w</option><option value = 'x'>x</option><option value = 'y'>y</option><option value='z'>z</option></select></div><input type = 'hidden' name = 'cmd' value = 'tautogram' id = 'cmd'><input type ='Submit' value = 'Run'><div class = 'tool-explain'>The tautogram is a constraint which sorts out all words beginning with a selected letter.</div></form>">Tautogram</a>
						...
						<a href = "#" data-toggle="popover" data-html="true" title = "Univocalism" data-content = "<form onsubmit = 'return runTool(this)' action = '#'><div class = 'styled-select'><select name = 'lttr' id = 'lttr'><option value = 'a'>a</option><option value = 'e'>e</option><option value = 'i'>i</option><option value = 'o'>o</option><option value = 'u'>u</option></select></div><input type = 'hidden' name = 'cmd' value = 'univocalism' id = 'cmd'><input type ='Submit' value = 'Run'><div class = 'tool-explain'>Returns only words containing a selected vowel. If selecting 'I', words such as 'big' or 'bin' would appear; selecting 'O' would mean words such as 'bone' or 'boat' would not be allowed, but 'bog' would.</div></form>">Univocalism</a>
						<a href = "#" data-toggle="popover" data-html="true" title = "Snowball" data-content = "<form onsubmit = 'return runTool(this)' action = '#'><div class = 'styled-select'><select name = 'lttr' id = 'lttr'><option value = 'melt'>Melt</option><option value = 'freeze'>Standard</option></select></div><input type = 'hidden' name = 'cmd' value = 'snowball' id = 'cmd'><input type ='Submit' value = 'Run'><div class = 'tool-explain'>Sorts words in a text by length returning the list in descending order (melt) or ascending order (standard).</div></form>">Snowball</a>
					</div>
				</div>
				<div class = "dropdown" tabindex = "0" onclick = 'javascript: expandMenu("grammar");'>
					...
					<div class = "dropdown-content" id = "grammar-menu">
						...
						<a href = "#" data-toggle="popover" data-html="true" title = "Isolate Sentence" data-content = "<form onsubmit = 'return runTool(this)' action = '#'><div class = 'styled-select'><select name = 'punct' id = 'lttr'><option value = '!'>!</option><option value = '?'>?</option><option value = '.'>.</option></select></div><input type = 'hidden' name = 'cmd' value = 'isolate' id = 'cmd'><input type ='Submit' value = 'Run'><div class = 'tool-explain'>Returns only sentences that end with a punctuation mark of your choosing.</div></form>">Isolate Sentences</a>
						...
						<a href = "#" data-toggle="popover" data-html="true" title = "Synonymizer" data-content = "<form onsubmit = 'return runTool(this)' action = '#'><input type = 'hidden' name = 'cmd' value = 'synant' id = 'cmd'><input type ='Submit' value = 'Run'><div class = 'tool-explain'>Searches a predefined dictionary for synonyms of all words 3 characters and greater, substituting a random synonym from a contextual list.</div></form>">Synonymizer</a>
						<a href = "#" data-toggle="popover" data-html="true" title = "Alternator" data-content = "<form onsubmit = 'return runTool(this)' action = '#'><div class = 'styled-select'><select name = 'lttr' id = 'lttr'><option value = 'c'>Consonant-Vowel</option><option value = 'v'>Vowel-Consonant</option></select></div><input type = 'hidden' name = 'cmd' value = 'alternator' id = 'cmd'><input type ='Submit' value = 'Run'><div class = 'tool-explain'>Search for words which have alternating patterns of consonants and vowels, such as 'bones' or 'agog'.</div></form>">Alternator</a>
					</div>
				</div>
				...
				<div class = "dropdown"tabindex = "0" onclick = 'javascript: expandMenu("pop");'>
					...
					<div class = "dropdown-content" id = "pop-menu">
						...
						<a href = "#" data-toggle="popover" data-html="true" title = "Weather Forecast" data-content = "<form onsubmit = 'return runTool(this)' action = '#'><input type = 'hidden' name = 'cmd' value = 'weather' id = 'cmd'><input type ='Submit' value = 'Run'><div class = 'tool-explain'>Using a predefined (and periodically updated) list of weather-related terms, the 'Weather Forecast' searches a text for these terms, returning full sentences containing them.</div></form>">Weather Forecast</a>
						<a href = "#" data-toggle="popover" data-html="true" title = "Coloring Book" data-content = "<form onsubmit = 'return runTool(this)' action = '#'><input type = 'hidden' name = 'cmd' value = 'color' id = 'cmd'><input type ='Submit' value = 'Run'><div class = 'tool-explain'>Using a predefined (and periodically updated) list of names for colors, the 'Coloring Book' function retrieves all sentences containing colors.</div></form>">Coloring Book</a>
					</div>
				</div>
				...
				<div class = "dropdown" tabindex = "0" onclick = 'javascript: expandMenu("text");'>
					...
					<a class = "file-opts" href = '#' data-toggle = "popover" data-html = "true" title = "Really Clear Screen?" data-content = "<form onsubmit = 'return clearScreen(this)'><input type = 'Submit' value = 'Clear Screen'><div class = 'tool-explain'></div></form>"style = "width: inherit;">Clear Screen</a>

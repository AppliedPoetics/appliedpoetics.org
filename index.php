			...
			<div id = "option-container">
				...
				<div class = "dropdown" tabindex = "0" onclick = 'javascript: expandMenu("grammar");'>
					...
					<div class = "dropdown-content" id = "grammar-menu">
						...
						<!--<a href = "#" data-toggle="popover" data-html="true" title = "Alternator" data-content = "<form onsubmit = 'return runTool(this)' action = '#'><select name = 'lttr' id = 'lttr'><option value = 'c'>Consonant-Vowel</option><option value = 'v'>Vowel-Consonant</option></select><input type = 'hidden' name = 'cmd' value = 'alternator' id = 'cmd'><input type ='Submit' value = 'Run'><div class = 'tool-explain'>Search for words which have alternating patterns of consonants and vowels, such as 'bones' or 'agog'.</div></form>">Alternator</a>-->
					</div>
				</div>

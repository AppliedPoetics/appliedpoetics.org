			...
			<div id = "option-container">
				...
				<div class = "dropdown" tabindex = "0" onclick = 'javascript: expandMenu("algo");'>
					...
					<div class = "dropdown-content" id = "algo-menu">
						...
						<a href = "#" id = "colorfield" data-toggle="popover" data-html="true" title = "Color Field" data-content = "<form onsubmit = 'return runTool(this)' action = '#'><input type = 'hidden' name = 'cmd' value = 'colorfield' id = 'cmd'><input id='filename' placeholder='Choose file.' disabled='disabled' /><div class = 'fileupload btn btn-primary'>Choose Image<input type = 'file' class = 'upload' id = 'uploadbtn' /></div><br/><br/><div class = 'styled-select'><select name = 'lttr' id = 'lttr'><option value = 'sentences'>Containing</option><option value = 'letters'>Spelled By</option></select></div><hr/><input type ='Submit' value = 'Run'><br/><div class = 'tool-explain'>{TEXT}</div></form>">Color Field</a>
					</div>
				</div>
